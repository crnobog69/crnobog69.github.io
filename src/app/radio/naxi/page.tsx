...
export default function NaxiPage() {
  ...
  const streamUrl = "https://naxi128.streaming.rs:9152/;";
  const fallbackStreamUrl = "http://naxi48.streaming.rs:9180/listen.pls;"; // Alternative stream URL for fallback
          ...
          <section className="max-w-4xl mx-auto space-y-6 md:space-y-10">
            <div className="text-center space-y-4 md:space-y-6">
              <div className="flex justify-center">
                <RadioTower className="h-16 w-16 md:h-20 md:w-20 text-orange-500" />
              </div>
              <h1 className="text-3xl md:text-5xl font-bold">Радио Naxi</h1>
              <p className="text-base md:text-xl text-muted-foreground">
                96,4: Београд, Република Србија
              </p>
            </div>
                ...
                <div className="absolute inset-0 opacity-20 pointer-events-none">
                  <div className="absolute bottom-0 left-0 right-0 h-28 md:h-40 flex items-end justify-around">
                    {[...Array(20)].map((_, i) => (
                      <div
                        key={i}
                        className="w-1 md:w-1.5 bg-orange-500 rounded-t-full audio-bar"
                        style={{
                          height: "5%",
                ...
                <div className="flex items-center justify-center gap-4 mt-2 md:mt-4">
                  <Button
                    ...
                    className={`h-14 w-14 md:h-16 md:w-16 rounded-full shadow-sm transition-all ${
                      isPlaying
                        ? "border-orange-500 shadow-orange-500/10 bg-orange-500/5"
                        : ""
                    }`}
                  ...
                  >
                    {isLoading ? (
                      ...
                      <Pause
                        className={`h-7 w-7 md:h-8 md:w-8 ${isPlaying ? "text-orange-500" : ""}`}
                      />
                    ) : (
                ...
                <div className="mt-6 md:mt-8">
                  ...
                  >
                    <div className="text-center text-sm md:text-base text-muted-foreground mt-4 pt-4 border-t border-border">
                      <p>Стрим се емитује директно са сервера Радио Naxi.</p>
                      <p className="mt-2">
